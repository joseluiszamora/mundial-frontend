        ...
        <v-layout row wrap>
          <v-flex class="md12">
            <div v-show="!getDisplay.tareas">
              ...
              <actividades-lista fase="fase2" v-show="getDisplayActividades.listado"></actividades-lista>
              <!-- Formulario de Obras -->
...
import ActividadesLista from '../actividad/ActividadesPorFaseLista.vue'
import ActividadForm from '../actividad/FormFase.vue'
// import ValorProporcional from '../obra/ValorProporcional.vue'
import ActividadMain from '../actividad/ActividadMain.vue'

export default {
  components: { ActividadesLista, ActividadForm, ActividadMain },
  name: 'actividadFase',
  data () {
    return {
